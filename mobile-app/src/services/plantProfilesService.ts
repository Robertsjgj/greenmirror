...
function sanitizePlantProfileForFirestore(profile: PlantProfile): Record<string, unknown> {
  ...
  return {
    ...
    profileSource: profile.profileSource ?? 'custom',
    sourcePlantName: profile.sourcePlantName ?? '',
    requiresUserReview: profile.requiresUserReview ?? false,
    requirementNotes: profile.requirementNotes ?? [],
    preferredSoilTempMin: profile.preferredSoilTempMin ?? null,
    preferredSoilTempMax: profile.preferredSoilTempMax ?? null,
    toleratedSoilTempMin: profile.toleratedSoilTempMin ?? null,
    toleratedSoilTempMax: profile.toleratedSoilTempMax ?? null,
    sandySoilVwcMin: profile.sandySoilVwcMin ?? null,
    sandySoilVwcMax: profile.sandySoilVwcMax ?? null,
    loamSoilVwcMin: profile.loamSoilVwcMin ?? null,
    loamSoilVwcMax: profile.loamSoilVwcMax ?? null,
    claySoilVwcMin: profile.claySoilVwcMin ?? null,
    claySoilVwcMax: profile.claySoilVwcMax ?? null,
    updatedAt: now,
    createdAt: now,
  };
}
