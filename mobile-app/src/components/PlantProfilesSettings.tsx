  ...
  return (
    <div className="mt-5 border-t border-stone-100 pt-5">
      <div className="mb-3 flex items-start justify-between gap-3">
        <div>
          <h3 className="text-lg font-bold text-stone-800">Plant Profiles</h3>
        ...
        {editingId && (
          <button
            type="button"
            onClick={resetDraft}
            className="rounded-xl border border-stone-200 px-3 py-2 text-xs font-bold text-stone-500"
          >
            New
          </button>
        )}
              ...
              <div className="flex items-start justify-between gap-2">
                <div className="min-w-0">
                  ...
                  <p className="text-[10px] font-bold uppercase tracking-wider text-stone-400">
                    {profile.moistureMin}-{profile.moistureMax}% water | {profile.soilTempMin}-{profile.soilTempMax}C
                  </p>
                </div>
                  ...
                  {!isDefault && (
                    <>
                      <button
                        ...
                        className="rounded-lg bg-white px-2 py-1 text-[10px] font-bold text-stone-600"
                      >
                        Edit
                      </button>
                      <button
      ...
      <div className="mt-4 rounded-2xl border border-stone-200 bg-white p-3">
        <div className="grid grid-cols-2 gap-2">
          <label className="col-span-2">
            ...
            <input
              ...
              className="mt-1 w-full rounded-xl border border-stone-200 px-3 py-2 text-sm font-bold text-stone-800 outline-none focus:ring-2 focus:ring-emerald-500"
            />
          </label>
          ...
          <label className="col-span-2">
            ...
            <input
              ...
              className="mt-1 w-full rounded-xl border border-stone-200 px-3 py-2 text-sm font-medium text-stone-700 outline-none focus:ring-2 focus:ring-emerald-500"
            />
          </label>
        </div>
        ...
        <button
          ...
          disabled={!canSave}
          onClick={saveDraft}
          className="mt-3 flex w-full items-center justify-center gap-2 rounded-xl bg-emerald-600 py-2.5 text-sm font-bold text-white transition-colors hover:bg-emerald-700 disabled:opacity-50"
        >
